export default {
  translation: {
    ...
    'Clear all': 'مسح الكل',
    'Auth Required': 'مطلوب مصادقة',
    'Payment Required': 'مطلوب دفع',
    'Relay payment page': 'صفحة دفع المرحل',
    'Supported Features': 'الميزات المدعومة',
    Contacts: 'جهات الاتصال',
    'Encrypted DMs': 'رسائل مشفرة',
    'Event Deletion': 'حذف الأحداث',
    'Relay Info': 'معلومات المرحل',
    'Private Messages': 'رسائل خاصة',
    Channels: 'القنوات',
    Expiration: 'انتهاء الصلاحية',
    Authentication: 'المصادقة',
    'Relay Access': 'الوصول للمرحل',
    'Event Counts': 'عدد الأحداث',
    Reporting: 'الإبلاغ',
