export default {
  translation: {
    ...
    'Relay payment page': 'หน้าชำระเงินรีเลย์',
    'Supported Features': 'ฟีเจอร์ที่รองรับ',
    Contacts: 'ผู้ติดต่อ',
    'Encrypted DMs': 'DM เข้ารหัส',
    'Event Deletion': 'ลบอีเวนต์',
    'Relay Info': 'ข้อมูลรีเลย์',
    'Private Messages': 'ข้อความส่วนตัว',
    Channels: 'ช่อง',
    Expiration: 'หมดอายุ',
    Authentication: 'การยืนยันตัวตน',
    'Relay Access': 'การเข้าถึงรีเลย์',
    'Event Counts': 'จำนวนอีเวนต์',
    Reporting: 'การรายงาน',
