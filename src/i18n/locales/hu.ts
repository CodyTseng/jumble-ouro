export default {
  translation: {
    ...
    'Auth Required': 'Hitelesítés szükséges',
    'Payment Required': 'Fizetés szükséges',
    'Relay payment page': 'Relay fizetési oldal',
    'Supported Features': 'Támogatott funkciók',
    Contacts: 'Kapcsolatok',
    'Encrypted DMs': 'Titkosított DM-ek',
    'Event Deletion': 'Esemény törlése',
    'Relay Info': 'Relay információ',
    'Private Messages': 'Privát üzenetek',
    Channels: 'Csatornák',
    Expiration: 'Lejárat',
    Authentication: 'Hitelesítés',
    'Relay Access': 'Relay hozzáférés',
    'Event Counts': 'Események száma',
    Reporting: 'Jelentés',
