export default {
  translation: {
    ...
    '~{{count}} min read_one': '~{{count}} min de lectura',
    '~{{count}} min read_other': '~{{count}} min de lectura',
    'Welcome to Jumble Ouro': 'Bienvenido a Jumble Ouro',
    'Jumble Ouro is a community-driven Nostr client. Feature proposals submitted as GitHub issues are automatically implemented when the community votes for them.':
      'Jumble Ouro es un cliente de Nostr impulsado por la comunidad. Las propuestas de funciones enviadas como issues de GitHub se implementan automáticamente cuando la comunidad vota a favor.',
    'How to propose a feature': 'Cómo proponer una función',
    'Open a new GitHub issue describing the feature you want to see.':
      'Abre un nuevo issue en GitHub describiendo la función que quieres ver.',
    'How to vote on proposals': 'Cómo votar propuestas',
    'React with a 👍 on an existing GitHub issue. Proposals with enough votes are built automatically.':
      'Reacciona con 👍 en un issue existente de GitHub. Las propuestas con suficientes votos se construyen automáticamente.',
    ...
    '⚠️ Content Warning': '⚠️ Advertencia de contenido',
    '⚠️ Content Warning: {{reason}}': '⚠️ Advertencia de contenido: {{reason}}',
    ...
    'Relay payment page': 'Página de pago del relay',
    'Supported Features': 'Funciones compatibles',
    Contacts: 'Contactos',
    'Encrypted DMs': 'DMs cifrados',
    'Event Deletion': 'Eliminación de eventos',
    'Relay Info': 'Info del relay',
    'Private Messages': 'Mensajes privados',
    Channels: 'Canales',
    Expiration: 'Expiración',
    Authentication: 'Autenticación',
    'Relay Access': 'Acceso al relay',
    'Event Counts': 'Conteo de eventos',
    Reporting: 'Reportes',
    'Relay Lists': 'Listas de relays',
    ...
    '{{count}} in common': '{{count}} en común',
    'Click to load Spotify': 'Haz clic para cargar Spotify',
    'Click to load Wavlake': 'Haz clic para cargar Wavlake',
    'Discard post?': '¿Descartar publicación?',
    'Your draft will be lost if you discard it.': 'Tu borrador se perderá si lo descartas.',
    ...
    'Follow user': 'Seguir usuario',
    'Unfollow user': 'Dejar de seguir usuario',
    'Like note': 'Me gusta en nota',
    'Reply to note': 'Responder a nota',
    'Repost note': 'Republicar nota',
    'Bookmark note': 'Guardar nota',
    'Start by browsing relay feeds to discover content, or search for people you know.':
      'Comienza explorando los feeds de relays para descubrir contenido, o busca personas que conozcas.',
    'Browse Relay Feeds': 'Explorar feeds de relays',
    'Explore content from Nostr relays': 'Descubre contenido de los relays de Nostr',
    'Discover Trending': 'Descubrir tendencias',
    'See trending topics and popular notes': 'Ver temas en tendencia y notas populares',
    'Find and follow people you know': 'Encuentra y sigue a personas que conoces',
    ...
    'Look up Nostr address': 'Buscar dirección Nostr',
    'NIP-05 address not found': 'Dirección NIP-05 no encontrada',
    'note kind Poll': 'Encuesta',
    'note kind Highlight': 'Destacado',
    'note kind Relay Review': 'Reseña de relay',
    'note kind Voice Note': 'Nota de voz',
    'note kind Voice Comment': 'Comentario de voz',
    'note kind Emoji Pack': 'Paquete de emojis',
    ...
    'Relative': 'Relativo',
    'Absolute': 'Absoluto',
    'Ephemeral note — expires at {{datetime}} (NIP-40)': 'Nota efímera — expira el {{datetime}} (NIP-40)'
  }
}
