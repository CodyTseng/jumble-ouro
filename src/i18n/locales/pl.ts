export default {
  translation: {
    ...
    Messages: 'Wiadomości',
    Message: 'Wiadomość',
    'Configure DM Relays': 'Konfiguruj przekaźniki WP',
    'Select relays to use for direct messages. These relays will receive your encrypted messages.':
      'Wybierz przekaźniki do wiadomości prywatnych. Te przekaźniki będą odbierać twoje zaszyfrowane wiadomości.',
    'Your DM Relays': 'Twoje przekaźniki WP',
    'No relays configured': 'Brak skonfigurowanych przekaźników',
    'wss://relay.example.com': 'wss://relay.example.com',
    'Suggested Relays': 'Sugerowane przekaźniki',
    'Save and Continue': 'Zapisz i kontynuuj',
    'Saving...': 'Zapisywanie...',
    'Please add at least one relay': 'Dodaj co najmniej jeden przekaźnik',
    'DM relays saved': 'Przekaźniki WP zapisane',
    'Failed to save DM relays': 'Nie udało się zapisać przekaźników WP',
    'Relay already added': 'Przekaźnik już dodany',
    ...
    'No message requests': 'Brak próśb o wiadomości',
    ...
    'Welcome to Jumble Ouro': 'Witamy w Jumble Ouro',
    'Jumble Ouro is a community-driven Nostr client. Feature proposals submitted as GitHub issues are automatically implemented when the community votes for them.':
      'Jumble Ouro to klient Nostr tworzony przez społeczność. Propozycje funkcji zgłaszane jako issue na GitHubie są wdrażane automatycznie, gdy społeczność na nie zagłosuje.',
    'How to propose a feature': 'Jak zaproponować funkcję',
    'Open a new GitHub issue describing the feature you want to see.':
      'Otwórz nowe issue na GitHubie i opisz funkcję, którą chcesz zobaczyć.',
    'How to vote on proposals': 'Jak głosować na propozycje',
    ...
    '⚠️ Content Warning': '⚠️ Ostrzeżenie o treści',
    '⚠️ Content Warning: {{reason}}': '⚠️ Ostrzeżenie o treści: {{reason}}',
    'Content Warning': 'Ostrzeżenie o treści',
    'Reason (optional)': 'Powód (opcjonalnie)',
    OP: 'OP',
    'Recent search': 'Ostatnie wyszukiwanie',
    'Clear all': 'Wyczyść wszystko',
    'Auth Required': 'Wymagana autoryzacja',
    'Payment Required': 'Wymagana płatność',
    'Relay payment page': 'Strona płatności relay',
    'Supported Features': 'Obsługiwane funkcje',
    Contacts: 'Kontakty',
    'Encrypted DMs': 'Szyfrowane DM',
    'Event Deletion': 'Usuwanie wydarzeń',
    'Relay Info': 'Info o relay',
    'Private Messages': 'Prywatne wiadomości',
    Channels: 'Kanały',
    Expiration: 'Wygaśnięcie',
    Authentication: 'Autoryzacja',
    'Relay Access': 'Dostęp do relay',
    'Event Counts': 'Liczba wydarzeń',
    Reporting: 'Zgłaszanie',
    'Relay Lists': 'Listy relay',
    'Protected Events': 'Chronione wydarzenia',
    'File Storage': 'Przechowywanie plików',
    'Trending Topics': 'Popularne tematy',
    'Share as image': 'Udostępnij jako obraz',
    'Download image': 'Pobierz obraz',
    'Share image': 'Udostępnij obraz',
    'Generating image...': 'Generowanie obrazu...',
    'Failed to generate image': 'Nie udało się wygenerować obrazu',
    'More from': 'Więcej od',
    'View profile': 'Zobacz profil',
    'Copy profile link': 'Kopiuj link do profilu',
    ...
    'Look up Nostr address': 'Wyszukaj adres Nostr',
    'NIP-05 address not found': 'Nie znaleziono adresu NIP-05',
    'note kind Poll': 'Ankieta',
    'note kind Highlight': 'Wyróżnienie',
    'note kind Relay Review': 'Recenzja przekaźnika',
    'note kind Voice Note': 'Notatka głosowa',
    'note kind Voice Comment': 'Komentarz głosowy',
    'note kind Emoji Pack': 'Paczka emoji',
