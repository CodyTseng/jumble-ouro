export default {
  translation: {
    ...
    '~{{count}} min read_one': '~{{count}} min di lettura',
    '~{{count}} min read_other': '~{{count}} min di lettura',
    'Welcome to Jumble Ouro': 'Benvenuto su Jumble Ouro',
    'Jumble Ouro is a community-driven Nostr client. Feature proposals submitted as GitHub issues are automatically implemented when the community votes for them.':
      'Jumble Ouro è un client Nostr guidato dalla comunità. Le proposte di funzionalità inviate come issue su GitHub vengono implementate automaticamente quando la comunità vota a favore.',
    'How to propose a feature': 'Come proporre una funzionalità',
    'Open a new GitHub issue describing the feature you want to see.':
      'Apri una nuova issue su GitHub descrivendo la funzionalità che vorresti vedere.',
    'How to vote on proposals': 'Come votare le proposte',
    'React with a 👍 on an existing GitHub issue. Proposals with enough votes are built automatically.':
      'Reagisci con 👍 su una issue GitHub esistente. Le proposte con abbastanza voti vengono realizzate automaticamente.',
    'Open GitHub issues': 'Apri le issue GitHub',
    "Let's go": 'Andiamo',
    Copied: 'Copiato',
    Share: 'Condividi',
    ...
    '⚠️ Content Warning': '⚠️ Avviso sul contenuto',
    ...
    'Relay payment page': 'Pagina di pagamento del relay',
    'Supported Features': 'Funzionalità supportate',
    Contacts: 'Contatti',
    'Encrypted DMs': 'DM crittografati',
    'Event Deletion': 'Eliminazione eventi',
    'Relay Info': 'Info relay',
    'Private Messages': 'Messaggi privati',
    Channels: 'Canali',
    Expiration: 'Scadenza',
    Authentication: 'Autenticazione',
    'Relay Access': 'Accesso al relay',
    'Event Counts': 'Conteggio eventi',
    ...
    'Generating image...': "Generazione dell'immagine...",
    ...
    'Click to load Spotify': 'Clicca per caricare Spotify',
    'Click to load Wavlake': 'Clicca per caricare Wavlake',
    'Discard post?': 'Eliminare il post?',
    ...
    'Image opened in new tab to save manually':
      'Immagine aperta in una nuova scheda per il salvataggio manuale',
    'You are offline': 'Sei offline',
    'Back online': 'Di nuovo online',
    'Table of contents': 'Indice',
    Shared: 'Condivisi',
    'Shared Relays': 'Relay condivisi',
    'No shared relays': 'Nessun relay condiviso',
    'View full profile': 'Visualizza profilo completo',
    'Follow user': 'Segui utente',
    'Unfollow user': 'Smetti di seguire utente',
    'Like note': 'Mi piace alla nota',
    'Reply to note': 'Rispondi alla nota',
    'Repost note': 'Ripubblica nota',
    'Bookmark note': 'Aggiungi nota ai segnalibri',
    'Start by browsing relay feeds to discover content, or search for people you know.':
      'Inizia esplorando i feed dei relay per scoprire contenuti, oppure cerca persone che conosci.',
    'Browse Relay Feeds': 'Esplora i feed dei relay',
    'Explore content from Nostr relays': 'Scopri contenuti dai relay di Nostr',
    'Discover Trending': 'Scopri le tendenze',
    'See trending topics and popular notes': 'Vedi argomenti di tendenza e note popolari',
    'Find and follow people you know': 'Trova e segui persone che conosci',
    'Copy link': 'Copia link',
    'Could not load relay info': 'Impossibile caricare le informazioni del relay',
    'Load new notes': 'Carica nuove note',
    'Clear note focus': 'Rimuovi focus nota',
    'Select a note, profile, or relay to view here':
      'Seleziona una nota, un profilo o un relay da visualizzare qui',
    'Navigate notes': 'Naviga tra le note',
    ...
    'Proof of Work: difficulty {{difficulty}} — this note was mined with computational effort (NIP-13)':
      'Proof of Work: difficoltà {{difficulty}} — questa nota è stata minata con sforzo computazionale (NIP-13)',
    'Look up Nostr address': 'Cerca indirizzo Nostr',
    'NIP-05 address not found': 'Indirizzo NIP-05 non trovato',
    'note kind Poll': 'Sondaggio',
    'note kind Highlight': 'In evidenza',
    'note kind Relay Review': 'Recensione relay',
    'note kind Voice Note': 'Nota vocale',
    'note kind Voice Comment': 'Commento vocale',
    'note kind Emoji Pack': 'Pacchetto emoji',
    'note kind Follow Pack': 'Pacchetto seguiti',
    'note kind Live': 'In diretta',
    'note kind Community': 'Comunità',
    'note kind Group': 'Gruppo',
    'Content font size': 'Dimensione del carattere del contenuto',
