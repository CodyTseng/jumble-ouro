export default {
  translation: {
    ...
    '~{{count}} min read_one': '~{{count}} min de lecture',
    '~{{count}} min read_other': '~{{count}} min de lecture',
    'Welcome to Jumble Ouro': 'Bienvenue sur Jumble Ouro',
    'Jumble Ouro is a community-driven Nostr client. Feature proposals submitted as GitHub issues are automatically implemented when the community votes for them.':
      "Jumble Ouro est un client Nostr animé par la communauté. Les propositions de fonctionnalités soumises sous forme d'issues GitHub sont automatiquement implémentées lorsque la communauté vote pour elles.",
    'How to propose a feature': 'Comment proposer une fonctionnalité',
    'Open a new GitHub issue describing the feature you want to see.':
      'Ouvrez une nouvelle issue GitHub décrivant la fonctionnalité que vous souhaitez voir.',
    'How to vote on proposals': 'Comment voter pour les propositions',
    'React with a 👍 on an existing GitHub issue. Proposals with enough votes are built automatically.':
      'Réagissez avec 👍 sur une issue GitHub existante. Les propositions avec suffisamment de votes sont construites automatiquement.',
    ...
    '⚠️ Content Warning': '⚠️ Avertissement de contenu',
    ...
    'Relay payment page': 'Page de paiement du relais',
    'Supported Features': 'Fonctionnalités prises en charge',
    Contacts: 'Contacts',
    'Encrypted DMs': 'DMs chiffrés',
    'Event Deletion': "Suppression d'événements",
    'Relay Info': 'Info du relais',
    'Private Messages': 'Messages privés',
    Channels: 'Canaux',
    Expiration: 'Expiration',
    Authentication: 'Authentification',
    'Relay Access': 'Accès au relais',
    'Event Counts': "Nombre d'événements",
    Reporting: 'Signalement',
    'Relay Lists': 'Listes de relais',
    ...
    'Start by browsing relay feeds to discover content, or search for people you know.':
      'Commencez par parcourir les flux de relais pour découvrir du contenu, ou recherchez des personnes que vous connaissez.',
    'Browse Relay Feeds': 'Parcourir les flux de relais',
    'Explore content from Nostr relays': 'Explorer le contenu des relais Nostr',
    'Discover Trending': 'Découvrir les tendances',
    'See trending topics and popular notes': 'Voir les sujets tendance et les notes populaires',
    ...
    'Select a note, profile, or relay to view here':
      "Sélectionnez une note, un profil ou un relais pour l'afficher ici",
    'Navigate notes': 'Naviguer dans les notes',
    ...
    'Zap presets': 'Préréglages de Zap',
    'Save presets': 'Enregistrer les préréglages',
    ...
    'Proof of Work: difficulty {{difficulty}} — this note was mined with computational effort (NIP-13)':
      'Preuve de travail : difficulté {{difficulty}} — cette note a été minée avec un effort de calcul (NIP-13)',
    'Look up Nostr address': 'Rechercher une adresse Nostr',
    'NIP-05 address not found': 'Adresse NIP-05 introuvable',
    'note kind Poll': 'Sondage',
    'note kind Highlight': 'Extrait',
    'note kind Relay Review': 'Avis de relais',
    'note kind Voice Note': 'Note vocale',
    'note kind Voice Comment': 'Commentaire vocal',
    'note kind Emoji Pack': 'Pack d\'emojis',
