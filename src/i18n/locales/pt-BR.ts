export default {
  translation: {
    ...
    'Relay payment page': 'Página de pagamento do relay',
    'Supported Features': 'Recursos suportados',
    Contacts: 'Contatos',
    'Encrypted DMs': 'DMs criptografadas',
    'Event Deletion': 'Exclusão de eventos',
    'Relay Info': 'Info do relay',
    'Private Messages': 'Mensagens privadas',
    Channels: 'Canais',
    Expiration: 'Expiração',
    Authentication: 'Autenticação',
    'Relay Access': 'Acesso ao relay',
    'Event Counts': 'Contagem de eventos',
    Reporting: 'Denúncias',
    ...
    Earlier: 'Anteriores',
    'Hashtag muted': 'Hashtag silenciada',
    'Hashtag unmuted': 'Hashtag reativada',
    'Open in...': 'Abrir em...',
    '{{count}} chars': '{{count}} caracteres',
    '{{count}} words': '{{count}} palavras',
    'Who to Follow': 'Quem seguir',
    '{{count}} in common': '{{count}} em comum',
    'Click to load Spotify': 'Carregar Spotify',
    'Click to load Wavlake': 'Carregar Wavlake',
    'Discard post?': 'Descartar publicação?',
    'Your draft will be lost if you discard it.': 'Seu rascunho será perdido se você descartá-lo.',
    ...
    'Image opened in new tab to save manually': 'Imagem aberta em nova aba para salvar manualmente',
    'You are offline': 'Você está offline',
    'Back online': 'De volta online',
    'Table of contents': 'Índice',
    Shared: 'Compartilhados',
    'Shared Relays': 'Relays compartilhados',
    'No shared relays': 'Nenhum relay compartilhado',
    'View full profile': 'Ver perfil completo',
    'Follow user': 'Seguir usuário',
    'Unfollow user': 'Deixar de seguir usuário',
    'Like note': 'Curtir nota',
    'Reply to note': 'Responder à nota',
    'Repost note': 'Repostar nota',
    'Bookmark note': 'Salvar nota nos favoritos',
    'Start by browsing relay feeds to discover content, or search for people you know.':
      'Comece navegando pelos feeds de relays para descobrir conteúdo, ou procure pessoas que você conhece.',
    'Browse Relay Feeds': 'Navegar feeds de relays',
    'Explore content from Nostr relays': 'Explore conteúdo dos relays do Nostr',
    'Discover Trending': 'Descobrir tendências',
    'See trending topics and popular notes': 'Veja tópicos em alta e notas populares',
    'Find and follow people you know': 'Encontre e siga pessoas que você conhece',
    'Copy link': 'Copiar link',
    'Could not load relay info': 'Não foi possível carregar as informações do relay',
    'Load new notes': 'Carregar novas notas',
    'Clear note focus': 'Limpar foco da nota',
    ...
    'Look up Nostr address': 'Buscar endereço Nostr',
    'NIP-05 address not found': 'Endereço NIP-05 não encontrado',
    'note kind Poll': 'Enquete',
    'note kind Highlight': 'Destaque',
    'note kind Relay Review': 'Avaliação de relay',
    'note kind Voice Note': 'Nota de voz',
    'note kind Voice Comment': 'Comentário de voz',
    'note kind Emoji Pack': 'Pacote de emojis',
    'note kind Follow Pack': 'Pacote de seguidos',
    'note kind Live': 'Ao vivo',
    'note kind Community': 'Comunidade',
    'note kind Group': 'Grupo',
    'Content font size': 'Tamanho da fonte do conteúdo',
    'Extra Large': 'Extra grande',
    'Timestamp format': 'Formato de data/hora',
    'Relative': 'Relativo',
    'Absolute': 'Absoluto',
    'Ephemeral note — expires at {{datetime}} (NIP-40)': 'Nota efêmera — expira em {{datetime}} (NIP-40)'
  }
}
